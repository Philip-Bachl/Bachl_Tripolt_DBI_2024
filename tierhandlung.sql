...
DROP TABLE Futter CASCADE CONSTRAINTS;
...
DROP TABLE Tier_ist_in_Filiale CASCADE CONSTRAINTS;
DROP TABLE Filiale_hat_Futter CASCADE CONSTRAINTS;
DROP TABLE Kunde CASCADE CONSTRAINTS;
DROP TABLE Bestellung CASCADE CONSTRAINTS;
DROP TABLE Bestellung_hat_Tier CASCADE CONSTRAINTS;
DROP TABLE Bestellung_hat_Futter CASCADE CONSTRAINTS;
